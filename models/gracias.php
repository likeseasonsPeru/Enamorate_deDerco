                ...
                <div class="post-content">
                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            dataLayer.push({
                                ...
                                'ecommerce': {
                                    'purchase': {
                                        'actionField': {
                                            'id': 'T1584480131', // Transaction ID. Required for purchases and refunds.
                                            'affiliation': 'Catalogo Derco',
                                            'revenue': '00.00' // Total transaction value (incl. tax and shipping)
                                        },
                                        'products': [{ // List of productFieldObjects.
                                            'name': 'OROCH INTENS 4X2 2.0 6MT', // Name or ID is required.
                                            'price': '00.00',
                                            'brand': 'RENAULT',
                                            'category': 'Oroch',
                            ...
                            dataLayer.push({
                                ...
                                'virtualPageURL': '/catalogo-derco/paso4',
                            });
                        ...
                        /*window.setTimeout(function(){
                            ...
                            window.location.href = "https://derco.com.pe/catalogo-derco/RENAULT";

                        }, 5000);*/

                        //Regresar a la lista de Marcas
                        $('#bt-atras').click(function() {
                            //window.location.href = "resultados.php?marca=RENAULT";
